...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:murid')->group(function () {
        Route::get('absen/murid/index', [AbsenController::class, 'indexMurid'])->name('absen.murid.index');
    });

    Route::middleware('role:guru')->group(function () {
        Route::get('absen/wali_kelas/index', [AbsenController::class, 'indexWaliKelas'])->name('absen.wali_kelas.index');
        Route::get('absen/wali_kelas/form/{kelas_id?}', [AbsenController::class, 'formWaliKelas'])->name('absen.wali_kelas.form');
        Route::post('absen/wali_kelas/form', [AbsenController::class, 'storeWaliKelas'])->name('absen.wali_kelas.store');
    ...
    Route::middleware('role:admin')->group(function () {
        ...
        Route::get('absen/admin/index', [AbsenController::class, 'indexAdmin'])->name('absen.admin.index');
        Route::get('absen/admin/form/{kelas_id?}', [AbsenController::class, 'formAdmin'])->name('absen.admin.form');
        Route::post('absen/admin/form', [AbsenController::class, 'storeAdmin'])->name('absen.admin.store');
    ...
    Route::get('/dashboard', [PengumumanController::class, 'dashboard'])->middleware(['auth', 'verified'])->name('dashboard');
